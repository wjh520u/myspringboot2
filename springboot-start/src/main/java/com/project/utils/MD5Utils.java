...
public class MD5Utils {
	 ...
	 * 普通MD5加密 01
	 */
	public static String getCommomMD5(String inStr) {
		// 获取MD5实例
	 ...
	 * 普通MD5加密 02
	 */
	public static String getCommonMD5_2(String password) {
	...
	public static void main(String[] args) {
		...
		System.out.println("东东的：" + getCommonMD5_2(strMD5));
		System.out.println("MD5后：" + getCommomMD5(strMD5));
		...
		System.out.println("普通MD5后：" + MD5Utils.getCommomMD5(plaintext));

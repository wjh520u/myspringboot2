package com.other.netty.tcp.decoder;

import java.util.List;

import com.other.netty.tcp.properties.response.ConstantValue;
import com.other.netty.tcp.properties.response.SmartCarProtocol;
